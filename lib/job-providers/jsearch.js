import { JobProvider, PAGE_SIZE, encodeJobId, stripHtml } from './types';
...
export async function searchJsearch(params) {
  ...
  if (!apiKey) {
    return { ok: false, quotaExceeded: false, error: 'Missing JSEARCH_API_KEY in environment variables.' };
  }
